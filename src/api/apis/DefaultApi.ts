...
export class DefaultApi extends runtime.BaseAPI {
   ...
   *
   */
  async createInstallationRaw(
    requestParameters: CreateInstallationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<PostInstallationResponse>> {
    ...
    const response = await this.request(
      {
        ...
        body: PostInstallationRequestToJSON(
          requestParameters['postInstallationRequest'],
        ),
      },
      initOverrides,
    )
    ...
    return new runtime.JSONApiResponse(response, jsonValue =>
      PostInstallationResponseFromJSON(jsonValue),
    )
  }
  ...
  async createInstallation(
    requestParameters: CreateInstallationRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<PostInstallationResponse> {
    const response = await this.createInstallationRaw(
      requestParameters,
      initOverrides,
    )
   ...
   *
   */
  async deleteInstallationRaw(
    requestParameters: DeleteInstallationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ...
    const response = await this.request(
      {
        path: `/auth/installations/{id}`.replace(
          `{${'id'}}`,
        ...
        headers: headerParameters,
        query: queryParameters,
        body: PutInstallationRequestToJSON(
          requestParameters['putInstallationRequest'],
        ),
      },
      initOverrides,
    )
  ...
  async getInstallationRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Installation>> {
    if (requestParameters['id'] == null) {
      throw new runtime.RequiredError(
        'id',
    ...
    return new runtime.JSONApiResponse(response, jsonValue =>
      InstallationFromJSON(jsonValue),
    )
  }
   ...
   *
   */
  async getInstallationsRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<Installation>>> {
    const queryParameters: any = {}
    ...
    return new runtime.JSONApiResponse(response, jsonValue =>
      jsonValue.map(InstallationFromJSON),
    )
  }
   ...
   *
   */
  async updateInstallationRaw(
    requestParameters: UpdateInstallationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['id'] == null) {
      throw new runtime.RequiredError(

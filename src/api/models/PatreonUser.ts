...
export function instanceOfPatreonUser(value: object): value is PatreonUser {
  ...
  if (!('canSeeNsfw' in value) || value['canSeeNsfw'] === undefined)
    return false
  if (!('created' in value) || value['created'] === undefined) return false
  if (
    !('currentUserBlockStatus' in value) ||
    value['currentUserBlockStatus'] === undefined
  )
    return false
  ...
  if (!('isSuspended' in value) || value['isSuspended'] === undefined)
    return false
  if (!('lastName' in value) || value['lastName'] === undefined) return false
  if (!('patronCurrency' in value) || value['patronCurrency'] === undefined)
    return false
...
export function PatreonUserFromJSONTyped(
  json: any,
  ...
  return {
    ...
    ageVerificationStatus:
      json['age_verification_status'] == null
        ? undefined
        : json['age_verification_status'],
    ...
    defaultCountryCode:
      json['default_country_code'] == null
        ? undefined
    ...
    hasPassword:
      json['has_password'] == null ? undefined : json['has_password'],
    ...
    campaign:
      json['campaign'] == null
        ? undefined
        : PatreonCampaignFromJSON(json['campaign']),
    pledges:
      json['pledges'] == null
        ? undefined
        : (json['pledges'] as Array<any>).map(PatreonPledgeFromJSON),
  }
}
...
export function PatreonUserToJSONTyped(
  value?: PatreonUser | null,
  ...
  return {
    ...
    pledges:
      value['pledges'] == null
        ? undefined
        : (value['pledges'] as Array<any>).map(PatreonPledgeToJSON),
  }
}
